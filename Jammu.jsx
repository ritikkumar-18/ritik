...
export const Jammu = () => {
  return (
    ...
    <img
      src="https://d31aoa0ehgvjdi.cloudfront.net//eyJidWNrZXQiOiJ0aGV0YXJ6YW53YXktd2ViIiwia2V5IjoibWVkaWEvcGFnZS8xNjc0NjM1MDYxMDA4NTA0MzkwNzE2NTUyNzM0MzguanBnIiwiZWRpdHMiOnsicmVzaXplIjp7IndpZHRoIjo1MDAsImhlaWdodCI6NTAwLCJmaXQiOiJjb3ZlciJ9fX0="
      alt="Background"
    ...
    <div className="relative flex items-center justify-between px-10 h-full">
      ...
      <div className="text-white max-w-5xl space-y-6 absolute top-16 left-24">
        <h1 className="text-5xl font-extrabold leading-tight">Jammu & Kashmir<br />Let AI Be Your Expert Guide.</h1>
