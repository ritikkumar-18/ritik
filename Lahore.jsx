...
export const Lahore = () => {
  return (
    ...
    <img
      src="https://d31aoa0ehgvjdi.cloudfront.net//eyJidWNrZXQiOiJ0aGV0YXJ6YW53YXktd2ViIiwia2V5IjoibWVkaWEvcGFnZS8xNjc0NjMyMzQxMjI0NjIxNTM0MzQ3NTM0MTc5NjkuanBnIiwiZWRpdHMiOnsicmVzaXplIjp7IndpZHRoIjoyMiwiaGVpZ2h0IjoxMCwiZml0IjoiY292ZXIifX19"
      alt="Background"
    ...
    <div className="relative flex items-center justify-between px-10 h-full">
      ...
      <div className="bg-white bg-opacity-80 p-3 rounded-lg shadow-lg max-w-md absolute right-20 top-6">
