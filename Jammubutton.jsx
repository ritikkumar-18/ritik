...
export const Button = () => {
  return (
    ...
    <div className="flex items-center justify-center ">
        <button className=" hover:bg-black text-black hover:text-white transition-all border border-black font-bold py-3 px-6 rounded-md mt-14 ">Unlock your Adventure!</button>
    </div>
  </div>
  </section>
